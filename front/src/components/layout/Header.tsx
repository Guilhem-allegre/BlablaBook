      ...
      <header className="bg-header flex items-center gap-4 justify-between p-4 left-0 w-full md:ml-64 md:px-10 ml:px-6 lg:px-10 backdrop-blur-sm transition-all font-title">
        ...
        <nav className="hidden md:flex gap-6 ml:gap-4">
          <Link
            to="/"
            aria-label="Accueil"
            className={`hover:text-yellow-700 dark:hover:text-yellow-500 ${isActive("/") ? "text-yellow-700 dark:text-yellow-500 font-bold" : ""}`}
          >
          ...
          <Link
            ...
            className={`hover:text-yellow-700 dark:hover:text-yellow-500 ${isActive("/library") ? "text-yellow-700 dark:text-yellow-500 font-bold" : ""}`}
          >
          ...
          {!user ? (
            <Link
              ...
              className={`hover:text-yellow-700 dark:hover:text-yellow-500 ${isActive("/auth") ? "text-yellow-700 dark:text-yellow-500 font-bold" : ""}`}
            >
            ...
            <Link
              ...
              className={`hover:text-yellow-700 dark:hover:text-yellow-500 ${isActive("/profile") ? "text-yellow-700 dark:text-yellow-500 font-bold" : ""}`}
            >
