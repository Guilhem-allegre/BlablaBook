...
const Footer = () => {
  return (
    <footer className="bg-body pb-20 flex px-8 py-2 text-sm md:text-base text-gray-500 font-bold md:bg-header md:block md:pb-0 mb:bottom-0 w-full md:pl-80 dark:text-placeholder">
