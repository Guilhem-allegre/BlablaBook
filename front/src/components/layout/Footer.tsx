...
const Footer = () => {
  return (
    <footer className="bg-body pb-20 flex px-8 py-2 text-sm md:text-base text-black font-bold md:bg-header md:block md:pb-0 mb:bottom-0 w-full md:pl-80 dark:text-placeholder">
      <ul className="flex flex-col xs:flex-row justify-between items-center font-title w-full py-4 border-t-2 md:border-none md:py-2">
        <li>
        ...
        <li>
          © Promo Sushi <br className="hidden md:block" /> Équipe BlaBlaBook
        </li>
      </ul>
    </footer>
  );
