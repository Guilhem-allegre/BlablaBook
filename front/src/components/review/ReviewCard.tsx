 ...
 * @param {string} param.username - The username of the reviewer.
 * @param {string} param.date - The date of the review.
 * @param {number} param.rating - The rating given in the review (0-5).
 * @param {string} param.review - The text content of the review.
