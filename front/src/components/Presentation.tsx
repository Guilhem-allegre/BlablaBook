      ...
      <section className="py-12 font-body px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed dark:text-placeholder">
            BlaBlaBook est une plateforme communautaire dédiée aux passionnés de lecture. Ici, vous pouvez explorer une large sélection de livres, sauvegarder
            ceux que vous souhaitez lire ou ceux que vous avez déjà lu !
          </p>
